...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        print("\nWARNING: You are launching the interface with public access enabled.")
        print("This means anyone with the link will be able to access the interface.")
        print("Make sure you have appropriate security measures in place.\n")
        
        # Launch with public access enabled
        iface.launch(
