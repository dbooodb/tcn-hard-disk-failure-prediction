...
import logging  # Import logging before other custom modules
import ray
...
logger = logging.getLogger('iSTEP')
...
def initialize_classification(*args):
    # Initialize Ray and Modin
    os.environ["MODIN_ENGINE"] = "ray"  # Set ray as the execution engine before any initialization
    ...
    try:
        ...
        print(f"Warning: Ray initialization error: {str(e)}")
        # Continue anyway as Ray might already be initialized
        pass
